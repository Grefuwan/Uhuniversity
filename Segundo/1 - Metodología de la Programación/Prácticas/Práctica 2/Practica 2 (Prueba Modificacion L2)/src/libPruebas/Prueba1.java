...
public class Prueba1 {
	public static void main(String[] args) {
		final Fecha f1 = new Fecha (29,2,2001), f2=new Fecha(f1), f3=(Fecha)f2.clone();
		Fecha 	fnac1 = new Fecha(7,3,1980),
				fnac2 = fnac1.diaSig(),
				fnac3 = new Fecha(27,06,1995),
				aux;
		...
		System.out.print("Fecha alta por defecto: " + Cliente.getDefaultFecha() + "\n");
		...
		c1.setFechaAlta(fnac1); c1.setNombreAtributo("Luis");
		c3.setFechaAlta(fnac3); c3.setNombreAtributo("Juan");
		...
		if (c2.equals(c1) && c3.equals(c4))
			Cliente.setDefaultFecha(f3.diaSig());
		...
		c[2]=cm;
		cm.setNombreAtributo(c1.getNombre());
		cm.setFechaAlta(f1);
		...
		c[5]=ct;
		ct.setNombreAtributo("Pepe");
		ct.setNacionalidad("India");
		ct.setMinutosHablados(500);
		cm.ver();
		ct.ver();
		ClienteTarifaPlana.setTarifaPlana(350, 22.50f); //cambia la Tarifa Plana a 350 min x 22.50
