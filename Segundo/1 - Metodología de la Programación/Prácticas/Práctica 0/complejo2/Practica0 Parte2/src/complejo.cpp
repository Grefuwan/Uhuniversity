...
//Constructor de Copia - Solo se usa si tiene memoria dinamica
...
//Metodos operator++() {
complejo complejo::operator++() { //Si pongo ++a, el *this será el valor a aumentado; devolver el propio objeto
  real++;
  return *this; //Lo que devuelvo es una copia; si quiero modificar el original, tendria que poner un &
}
...
complejo::operator int() {  //Conversor de complejo a int
  return real;
}
