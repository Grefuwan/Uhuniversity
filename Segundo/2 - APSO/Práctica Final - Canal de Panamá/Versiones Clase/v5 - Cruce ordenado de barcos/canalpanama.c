...
//Crear las FIFOS para las prioridades
...
//Crear los procesos de los gestores
	gEsclusae = creaproceso("gEsclusae"	,NULL);
	gEsclusao = creaproceso("gEsclusao"	,NULL);
	gLago 	  = creaproceso("gLago"		,NULL);		
...
//Enviar señal de finalizacion de los gestores
	kill (gEsclusae, 10);
	kill (gEsclusao, 10);
	kill (gLago, 10);
