...
% START ALGORITHM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Optimal_path=A_estrella(MAPA, delta, origen)
...
xTarget=floor(origen(1)/delta)+1;%X Coordinate of the Target
yTarget=floor(origen(2)/delta)+1;%Y Coordinate of the Target

MAPB(xTarget,yTarget)=0;%Initialize MAP with location of the target
plot(origen(1),origen(2),'rd');
text(origen(1),origen(2),'Start');
