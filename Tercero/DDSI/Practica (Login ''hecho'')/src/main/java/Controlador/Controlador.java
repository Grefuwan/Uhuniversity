...
//---------------------Actividades---------------------
    ...
    private void insertarTablaMonitores() throws SQLException, Exception{
        ...
        monDao.actualizarMonitor(monitor);
    }
    
    private void borrarMonitor () throws SQLException, Exception{  //Condicion Practica 4
        String codMonit = vMon.jTextField_Codigo.getText();
        monDao.borrarMonitor(codMonit);
    }
    
    private void actualizMonitor() throws SQLException, Exception{
        String cod = vMon.jTextField_Codigo.getText();
        String nom = vMon.jTextField_Nombre.getText();
        String dni = vMon.jTextField_DNI.getText();
        String tlf = vMon.jTextField_Telefono.getText();
    ...
    //----------------------------------------------------Socios----------------------------------------------------
    private void pideSocios() throws SQLException, Exception{
    ...
    private void insertarTablaSocios() throws SQLException, Exception{
    ...
    private void borrarSocio() throws SQLException, Exception{
        String numSoc = vSoc.jTextField_NumSocio.getText();
        socDao.eliminaSocio(numSoc);
    }
    
    private void actualizSocio() throws SQLException, Exception{
        String numSoc   = vSoc.jTextField_NumSocio.getText();
        String nombre   = vSoc.jTextField_Nombre.getText();
        String dni      = vSoc.jTextField_DNI.getText();
        String tlf      = vSoc.jTextField_Telefono.getText();
