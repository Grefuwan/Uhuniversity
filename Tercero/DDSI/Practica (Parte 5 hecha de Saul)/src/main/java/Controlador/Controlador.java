...
public class Controlador implements ActionListener{
    ...
    private VistaInscripcionesSocioActividad vInsc  = null;
    private InscripcionDAO      InscDAO             = null;
    private ControladorVistaInscripcionSocios cvInsc = null;
    ...
    public Controlador(Session conectP)  { //Instanciar todo lo creado arriba
        ...
        vInsc        = new VistaInscripcionesSocioActividad();
        InscDAO      = new InscripcionDAO();
...
//--------------------Inscripciones----------------------
    ...
    private void pideInscripcion() throws Exception{
        cvInsc = new ControladorVistaInscripcionSocios(sesion);
    }
