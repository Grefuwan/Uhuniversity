...
public class CanvasCola extends Canvas {
    ...
    private boolean msjColaLlena = false;
    private boolean msjColaVacia = false;
    ...
    public void paint(Graphics g) {
        ...
        og.drawString(mensaje, 150, 115);

        og.setColor(Color.black);
        og.setFont(numers);
        //og.drawString(String, int X, int Y);
        og.drawString(datos[0 % 4].toString(), 45, 250);
        og.drawString(datos[1 % 4].toString(), 165, 250);
        og.drawString(datos[2 % 4].toString(), 285, 250);
        og.drawString(datos[3 % 4].toString(), 420, 250);
    ...
    public void avisa(String mensaje) {
        ...
        if (mensaje.contentEquals("Desacola: Cola Vacia")) {
            msjColaVacia = true;
            og.setColor(Color.red);
        }
        else if (mensaje.contentEquals("Acola: Cola Llena")) {
            msjColaLlena = true;
